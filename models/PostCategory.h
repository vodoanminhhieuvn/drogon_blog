...
class PostCategory
{
  public:
    ...
    using PrimaryKeyType = std::tuple<int64_t,int64_t>;//post_id,category_id
     ...
     */
    explicit PostCategory(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit PostCategory(const Json::Value &pJson) noexcept(false);
     ...
     */
    PostCategory(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<PostCategory>;
    friend drogon::orm::BaseBuilder<PostCategory, true, true>;
    friend drogon::orm::BaseBuilder<PostCategory, true, false>;
    friend drogon::orm::BaseBuilder<PostCategory, false, true>;
    friend drogon::orm::BaseBuilder<PostCategory, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<PostCategory>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where post_id = $1 and category_id = $2";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where post_id = $1 and category_id = $2";
        return sql;
    }
