...
class PostTag
{
  public:
    ...
    using PrimaryKeyType = std::tuple<int64_t,int64_t>;//post_id,tag_id
     ...
     */
    explicit PostTag(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit PostTag(const Json::Value &pJson) noexcept(false);
     ...
     */
    PostTag(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<PostTag>;
    friend drogon::orm::BaseBuilder<PostTag, true, true>;
    friend drogon::orm::BaseBuilder<PostTag, true, false>;
    friend drogon::orm::BaseBuilder<PostTag, false, true>;
    friend drogon::orm::BaseBuilder<PostTag, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<PostTag>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where post_id = $1 and tag_id = $2";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where post_id = $1 and tag_id = $2";
        return sql;
    }
