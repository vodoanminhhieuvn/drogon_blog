...
class Post
{
  public:
     ...
     */
    explicit Post(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Post(const Json::Value &pJson) noexcept(false);
     ...
     */
    Post(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    PostMeta getPost_meta(const drogon::orm::DbClientPtr &clientPtr) const;
    void getPost_meta(const drogon::orm::DbClientPtr &clientPtr,
                      const std::function<void(PostMeta)> &rcb,
                      const drogon::orm::ExceptionCallback &ecb) const;
    std::vector<Post> getPosts(const drogon::orm::DbClientPtr &clientPtr) const;
    ...
    void getComments(const drogon::orm::DbClientPtr &clientPtr,
                     ...
                     const drogon::orm::ExceptionCallback &ecb) const;
    std::vector<std::pair<Tag,PostTag>> getTags(const drogon::orm::DbClientPtr &clientPtr) const;
    void getTags(const drogon::orm::DbClientPtr &clientPtr,
                 const std::function<void(std::vector<std::pair<Tag,PostTag>>)> &rcb,
                 const drogon::orm::ExceptionCallback &ecb) const;
    std::vector<std::pair<Category,PostCategory>> getCategories(const drogon::orm::DbClientPtr &clientPtr) const;
    void getCategories(const drogon::orm::DbClientPtr &clientPtr,
                       ...
                       const drogon::orm::ExceptionCallback &ecb) const;
  private:
    friend drogon::orm::Mapper<Post>;
    friend drogon::orm::BaseBuilder<Post, true, true>;
    friend drogon::orm::BaseBuilder<Post, true, false>;
    friend drogon::orm::BaseBuilder<Post, false, true>;
    friend drogon::orm::BaseBuilder<Post, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Post>;
#endif
